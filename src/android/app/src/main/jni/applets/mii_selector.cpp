...
void InitJNI(JNIEnv* env) {
    s_mii_selector_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("io/github/mandarine3ds/mandarine/applets/MiiSelector")));
    s_mii_selector_config_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/mandarine3ds/mandarine/applets/MiiSelector$MiiSelectorConfig")));
